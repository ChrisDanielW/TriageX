          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                delay: "0.1s",
                iconAnimation: "group-hover:animate-heartbeat"
              },
              {
                icon: Shield,
                ...
                delay: "0.2s",
                iconAnimation: "group-hover:animate-shield-pulse"
              },
              {
                icon: Users,
                title: "Team Ready",
              ...
              >
                <CardHeader className="text-center">
                  <div className={`w-16 h-16 ${feature.bgColor} rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform`}>
                    <feature.icon className={`w-8 h-8 ${feature.color} ${feature.iconAnimation}`} />
                  </div>
      ...
      <footer className="bg-gray-900 dark:bg-black text-white py-12 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-sm text-gray-500">
            © 2025 TriageX - For emergency medical use by qualified healthcare professionals
          </p>
        </div>
      </footer>
    </div>
